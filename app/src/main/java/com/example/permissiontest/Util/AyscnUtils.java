...
//     * @param listener
//     */
//    public void startConvertVideo(final Context context, final Uri uri, final Progresslistener listener) {
...
//
//
//                if (VideoUtils.initFrameFromVideoBySecond(context, framePath, uri, vi.width, vi.height, vi.time)) {
//                    emitter.onNext(50);
